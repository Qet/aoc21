...
// find the z range of each cubeoid and note whether they're an on or off type.
// find the total z range of all cubeoids. 
// move layer by layer from the top to the bottom, calculating how many squares are "on" on each layer. 
// a cubeoid is "active" if the current z value is within its z range. only consider the active cuboids. 